...
public class AddEBookCommand implements Command {
    @Override
    public String execute(String[] params) {
        ...
        try {
            return bookActionView.addBookView(bookService.addEBook(Integer.parseInt(id),author,Integer.parseInt(pages),name));
