...
public class ProposalPaperBookCommand implements Command {
    @Override
    public String execute(String[] params) {
        ...
        try {
            profileService.sendMessageWithProposalPaperBook(Integer.parseInt(id),author,Integer.parseInt(pages),name);
            return "";
