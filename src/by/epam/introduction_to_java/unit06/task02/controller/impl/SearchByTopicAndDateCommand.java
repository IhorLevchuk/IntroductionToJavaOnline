...
public class SearchByTopicAndDateCommand implements Command {
    @Override
    public String execute(String[] params) {
        ...
        try {
            return noteActionView.notesView(noteService.searchByTopicAndDate(topic,year,month,dayOfMonth));
